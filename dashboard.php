									...
									<form action="actions.php?a=source_update" class="form-horizontal form-bordered" method="post">
										...
										<div class="panel-body">
											...
											<div id="http" class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" id="http_server" name="http_server" value="http://<?php echo $_SERVER['SERVER_ADDR']; ?>:9000/hls/<?php echo $source['name']; ?>_sd.m3u8" readonly>
													<input type="text" class="form-control" id="http_server" name="http_server" value="http://<?php echo $_SERVER['SERVER_ADDR']; ?>:9000/hls/<?php echo $source['name']; ?>_hd.m3u8" readonly>
												</div>
											</div>
