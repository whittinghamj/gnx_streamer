...
echo '{"hostname": "'$HOSTNAME'","uptime": "'$UPTIME'", "cpu_usage": "'$CPU_USAGE'", "ram_usage": "'$RAM_USAGE'", "disk_usage": "'$DISK_USAGE'", "ip_address": "'$IPADDRESS'", "bandwidth_down": "'$RKBPS'", "bandwidth_up": "'$TKBPS'" }'
